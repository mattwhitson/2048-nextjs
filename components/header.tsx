...
export function Header() {
  ...
  return (
    <header className="w-full flex flex-row mb-12 items-center relative">
      ...
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className="size-8 hover:cursor-pointer hover:size-9 hover:transition-all absolute right-0"
